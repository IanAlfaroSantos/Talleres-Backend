...
export const firebaseConfig = {
  apiKey: process.env.FIREBASE_API_KEY || 'AIzaSyAJqZlm8vk27pkLnBfrojSyGITdCZBQIaw',
  authDomain: process.env.FIREBASE_AUTH_DOMAIN || 'mi-taller-pro-gtq.firebaseapp.com',
  projectId: process.env.FIREBASE_PROJECT_ID || 'mi-taller-pro-gtq',
  storageBucket: process.env.FIREBASE_STORAGE_BUCKET || 'mi-taller-pro-gtq.firebasestorage.app',
  messagingSenderId: process.env.FIREBASE_MESSAGING_SENDER_ID || '1096958123404',
  appId: process.env.FIREBASE_APP_ID || '1:1096958123404:web:cd69bbc0966ebfefce4aa9'
};
